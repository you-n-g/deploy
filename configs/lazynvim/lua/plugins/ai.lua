    ...
    keymaps = {
      ...
      custom_shortcuts = {
        ...
        },
        {
          ...
          reg = {
            f = function()
              return require("simplegpt.conf").format.text_rewrite .. "\n This text is generated by STT (Speech-to-Text) software, so it may not be accurate due to the flaws of STT and the pronunciation of the speaker. Please guess the right version when rewriting it."
            end,
          },
          opts = { noremap = true, silent = true, desc = "(S)peech-to-Text Rewrite" },
        },
        --   opts = { noremap = true, silent = true, desc = "(S)peech-to-Text Rewrite" },
        -- },
